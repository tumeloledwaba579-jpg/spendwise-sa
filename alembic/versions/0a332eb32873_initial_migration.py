...
Revision ID: 0a332eb32873
Revises: 
Create Date: 2026-02-21 22:58:32.174838
...
def upgrade() -> None:
    ...
    op.create_table('income_monthly_summary',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_income_monthly_summary_id'), 'income_monthly_summary', ['id'], unique=False)
    op.create_index(op.f('ix_income_monthly_summary_user_id'), 'income_monthly_summary', ['user_id'], unique=False)
    ...
    op.create_table('income_history',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_income_history_id'), 'income_history', ['id'], unique=False)
    op.create_index(op.f('ix_income_history_income_source_id'), 'income_history', ['income_source_id'], unique=False)
    op.create_index(op.f('ix_income_history_received_date'), 'income_history', ['received_date'], unique=False)
    op.create_index(op.f('ix_income_history_user_id'), 'income_history', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_income_history_income_source_id'), table_name='income_history')
    ...
    op.drop_index(op.f('ix_income_monthly_summary_user_id'), table_name='income_monthly_summary')
    op.drop_index(op.f('ix_income_monthly_summary_id'), table_name='income_monthly_summary')
