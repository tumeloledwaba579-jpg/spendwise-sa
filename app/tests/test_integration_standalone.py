"""
Standalone integration tests for SpendWise SA.
These tests don't require database or conftest.py setup.
They test schema/model alignment and enum handling directly.

Run with: py -3.11 -m pytest app/tests/test_integration_standalone.py -v
"""
...
class TestAccountIntegration:
    ...
    def test_account_all_enum_types(self):
        """Test all account enum types work correctly"""
        ...
        for account_type in account_types:
            ...
            assert serialized['account_type'] == account_type
            assert isinstance(serialized['account_type'], str)
